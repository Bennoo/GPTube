...
from langchain_functions.custom_chain import custom_qa_chain as custom_qa
...
def get_response_qa_from_query_bolt(query:str, app:App, chain_type:str):
    ...
    doc_chain = custom_qa.load_qa_chain(llm=app.openaiChat, chain_type='yt', verbose=True)
    ...
    answer = qa({"question": query, "metadata": app.meta_data, "chat_history": app.chat_history})
