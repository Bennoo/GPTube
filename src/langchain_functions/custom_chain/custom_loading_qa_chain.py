...
from .custom_qa_stuff_prompt import *
...
def _load_youtube_chain(
    llm: BaseLanguageModel,
    prompt: BasePromptTemplate = CUSTOM_YT_PROMPT,
    document_prompt: BasePromptTemplate = CUSTOM_YT_EXAMPLE_PROMPT,
    document_variable_name: str = "summaries",
    verbose: Optional[bool] = None,
    **kwargs: Any,
) -> StuffDocumentsChain:
